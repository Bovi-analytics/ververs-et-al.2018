...
summary(glmer2 <- glmer(G_TOTAL ~ CALC_ARRIVAL_BC_STD + (1| ANIMAL), 
                df.cv.cows, 
                family = gaussian(link="log"),
                control=glmerControl(optimizer="bobyqa")
                ))
...
##cld(lsmeans(glmer10b, pairwise~DH_QUARTER),
##          alpha=0.05,
##          Letters=letters,
##          adjust="tukey")
```
...
```{r, echo=FALSE}
lsmeans(glmer7, pairwise~N_DEHORNINGS, type = "response", adjust="tukey")
lsmeans(glmer7, pairwise~ B_QUARTER, type = "response")
# If you need the subscripts which differ
# cld(lsmeans(glmer7, pairwise~N_DEHORNINGS),
#           alpha=0.05,
#           Letters=letters,
#           adjust="tukey")
# cld(lsmeans(glmer7, pairwise~B_QUARTER),
#           alpha=0.05,
#           Letters=letters,
#           adjust="tukey")
```
...
```{r, echo=FALSE}
summary(glmer1 <- glmer(G_AH_L~ N_DEHORNINGS + (1|ANIMAL), 
                        df.cv.all.f.l, 
                        family = gaussian(link="log"),
                        control=glmerControl(optimizer="bobyqa")
                        ))
summary(glmer2 <- glmer(G_AH_L~ CALC_AGE_BC_STD + (1|ANIMAL), 
                        df.cv.all.f.l, 
                        family = gaussian(link="log"),
                        control=glmerControl(optimizer="bobyqa")
                        ))
summary(glmer3 <- glmer(G_AH_L~ DH_QUARTER + (1|ANIMAL), 
                        df.cv.all.f.l, 
                        family = gaussian(link="log"),
                        control=glmerControl(optimizer="bobyqa")
                        ))
summary(glmer4 <- glmer(G_AH_L~ B_QUARTER + (1|ANIMAL), 
                        df.cv.all.f.l, 
                        family = gaussian(link="log"),
                        control=glmerControl(optimizer="bobyqa")
                        ))
summary(glmer5 <- glmer(G_AH_L~ GENDER + (1|ANIMAL), 
                        df.cv.all.f.l, 
                        family = gaussian(link="log"),
                        control=glmerControl(optimizer="bobyqa")
                        ))
...
```{r, echo=FALSE}
lsmeans(glmer8, pairwise~N_DEHORNINGS, type = "response", adjust="tukey")
lsmeans(glmer8, pairwise~ B_QUARTER, type = "response")
# If you need the subscripts which differ
# cld(lsmeans(glmer8, pairwise~N_DEHORNINGS),
#           alpha=0.05,
#           Letters=letters,
#           adjust="tukey")
# cld(lsmeans(glmer8, pairwise~B_QUARTER),
#           alpha=0.05,
#           Letters=letters,
#           adjust="tukey")
```
...
```{r, echo=FALSE}
summary(glmer1 <- glmer(G_AH_C~ 
                          N_DEHORNINGS + (1|ANIMAL), 
                        df.cv.all.f.c, 
                        family = gaussian(link="log"),
                        control=glmerControl(optimizer="bobyqa")
                        ))
summary(glmer2 <- glmer(G_AH_C~ 
                          CALC_AGE_BC_STD + (1|ANIMAL), 
                        df.cv.all.f.c, 
                        family = gaussian(link="log"),
                        control=glmerControl(optimizer="bobyqa")
                        ))
summary(glmer3 <- glmer(G_AH_C~ 
                          DH_QUARTER + (1|ANIMAL), 
                        df.cv.all.f.c, 
                        family = gaussian(link="log"),
                        control=glmerControl(optimizer="bobyqa")
                        ))
summary(glmer4 <- glmer(G_AH_C~ 
                          B_QUARTER + (1|ANIMAL), 
                        df.cv.all.f.c, 
                        family = gaussian(link="log"),
                        control=glmerControl(optimizer="bobyqa")
                        ))
summary(glmer5 <- glmer(G_AH_C~ 
                          GENDER + (1|ANIMAL), 
                        df.cv.all.f.c, 
                        family = gaussian(link="log"),
                        control=glmerControl(optimizer="bobyqa")
